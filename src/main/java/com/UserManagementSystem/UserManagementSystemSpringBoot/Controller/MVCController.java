...
//	private CustomUserDetails customuser;
	...
	public String login(HttpServletRequest request, HttpSession session, Model model,Authentication authentication) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		  ...
		  if(cookies!=null)
			{
				for(Cookie cookie : cookies)
				{
					...
					if(cookie.getName().equals("Authorization"))
					{
							...
							User user = userservice.checkUser(username); // check the user is present in database or not
...
//	}
	...
	public String goingToEdit(HttpServletRequest request, HttpSession session, Model model) {
		...
		System.out.println("UsreRaole: "+user);
